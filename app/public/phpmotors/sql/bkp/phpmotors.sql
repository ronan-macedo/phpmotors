...
--
-- Host: mysql
-- Generation Time: Oct 02, 2022 at 02:15 AM
...
CREATE TABLE `clients` (
  ...
  `clientLastname` varchar(25) CHARACTER SET latin1 DEFAULT NULL,
  `clientEmail` varchar(40) CHARACTER SET latin1 NOT NULL,
  `clientPassword` varchar(255) CHARACTER SET latin1 NOT NULL,
  `clientLevel` enum('1','2','3') CHARACTER SET latin1 NOT NULL,
